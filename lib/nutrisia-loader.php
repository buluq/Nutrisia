<?php
/**
 * The file that defines the hooks registration
 *
 ...
 * and register them with the WordPress API. Call the run function
 * to execute the list of actions and filters.
 *
 * @package Nutrisia
 * @since 0.0.1
 */
class NutrisiaLoader {
	/**
...
/* End of file: nutrisia-loader.php */